...
This file points future build agents to the approved source material for the ECMA website rebuild. Do not copy secrets, CRM exports, private client lists, Base44 environment files, or unapproved compliance claims into this repository.

## Primary ECMA Context
